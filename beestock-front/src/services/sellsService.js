...
const API_URL = 'http://localhost:8000/ventas'; // Update with your API URL
...
export const getSellInfo = async (id) => {
    return handleResponse(axiosInstance.get(`/${id}/`));
};


export const paySell = async (id, data) => {
    return handleResponse(axiosInstance.post(`/${id}/pagar`, data));
};
