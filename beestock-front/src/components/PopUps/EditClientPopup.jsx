...
import { getOneClient, updateClient, getCondicionesTributarias } from '../../services/clientService';
import {
    Button,
    DialogActions,
    DialogContent,
    ...
    useEffect(() => {
        getOneClient(clientId)
            .then((res) => {
                ...
                setSelectedPais(cliente.pais.id)
                setSelectedProvincia(cliente.provincia.id)
                setClient({
                    cuit: cliente.cuit,
                    ...
                    condicionTributariaId: cliente.condicionTributaria.id,
                });
            })
            .catch((error) => {
                updateGlobalState({ loadingPage: false });
