...
import { getTiposServicio} from "../../services/supplierService";
    ...
    useEffect(() => {
        getOneSupplier(supplierId)
            .then((res) => {
                ...
                setSelectedPais(supplier.pais.id)
                setSelectedProvincia(supplier.provincia.id)
                setData({
                    piso: supplier.direccion.piso,
                    cuit: supplier.cuit,
                    numero: supplier.direccion.numero,
                    calle: supplier.direccion.calle,
                    correo: supplier.correo,
                    tipoServicios: supplier.tipoServicios.map(el => el.id),
                    localidadId: supplier.localidad.id,
