...
import { createIncident, getOneIncident, updateIncident } from '../../services/incidentsService';
import { updateInteraction } from '../../services/interactionsService';
...
const EditIncidentPopup = ({ onClose, incidentId, onUpdated }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        let payload = {
            descripcion: data.descripcion,
            fechaIncidente: data.fechaIncidente,
            fechaSolucion: data.estado === 2 ? data.fechaSolucion : null,
            estado: data.estado,
            proveedorId: data.proveedorId,
        }
        ...
        getOneIncident(incidentId)
            .then((res) => {
                ...
                setData({
                    descripcion: data.descripcion,
                    fechaIncidente: data.fechaIncidente,
                    fechaSolucion: data.fechaSolucion,
                    estado: data.estadoId,
                    proveedorId: data.proveedorId,
                });
                setDateFechaIncidente(dayjs(data.fechaIncidente));
                setDateFechaSolucion(dayjs(data.fechaSolucion));
